...
import { appsStatus } from "./comp/AppStatus";
...
export class ClusterPanel {
    ...
    private _disposables: Disposable[] = [];
     ...
     /**
   * The ClusterPanel class private constructor (called only from the render method).
   *
...
/**
 ...
 public static render(extensionUri: Uri) {
    if (ClusterPanel.currentPanel) {
      ...
      ClusterPanel.currentPanel._panel.reveal(ViewColumn.One);
    } else {
      ...
      ClusterPanel.currentPanel = new ClusterPanel(panel, extensionUri);
    }
  }  
 ...
 */
 private _setWebviewMessageListener(webview: Webview) {
  ...
  private _getWebviewContent(webview: Webview, extensionUri: Uri):string {
    ...
    const patternFlyUri = getUri(webview, extensionUri, [
      "node_modules",
      "@patternfly",
      "patternfly",
      "patternfly.css"
